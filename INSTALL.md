...
```sh
export GOVERSION=1.26.5 OS=linux ARCH=amd64  # change this as you need
...
```sh
sudo dnf install -y fuse3-devel libarchive-devel lzo-devel lz4-devel
```
...
```sh
VERSION=1.5.3  # this is the apptainer version, change as you need
# Fetch the source
