...
type TestEnv struct {
	...
	ImgCacheDir   string // ImgCacheDir sets the location of the image cache to be used by the Singularity command to be executed (instead of using APPTAINER_CACHE_DIR which should be avoided when running e2e tests)
	RunDisabled   bool
